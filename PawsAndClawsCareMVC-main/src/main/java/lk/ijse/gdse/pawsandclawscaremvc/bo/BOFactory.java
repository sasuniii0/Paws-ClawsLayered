...
public class BOFactory {
    ...
    public SupplierBO getBO(BOTypes types){
        switch (types){
            case CUSTOMER -> return new CustomerManageBOImpl();
            case EMPLOYEE -> return new EmpManageBOImpl();
            case INVENTORY -> return new InventoryManageBOImpl();
            case ORDERS -> return new OrderManageBOImpl();
            case PAYMENT -> return new PaymentBOImpl();
            case PET -> return new PetManageBOImpl();
            case PRODUCT -> return new ProductManageBOImpl();
